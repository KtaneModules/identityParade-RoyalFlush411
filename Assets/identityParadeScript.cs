...
public class identityParadeScript : MonoBehaviour
{
		...
		public void OnhairLeft()
		{
				...
				hairText.text = hairEntries[hairIndex].ToString();
		}
		...
		public void OnbuildLeft()
		{
				...
				buildText.text = buildEntries[buildIndex].ToString();
		}
		...
		public void OnattireLeft()
		{
				...
				attireText.text = attireEntries[attireIndex].ToString();
		}
		...
		public void OnsuspectLeft()
		{
				...
				suspectText.text = suspectEntries[suspectIndex].ToString();
		}
